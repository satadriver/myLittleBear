...
extern map <HWND, LPREMOTE_CONTROL_PARAM> RemoteCtrlParamMap;

extern map<HWND, LPREMOTE_CONTROL_PARAM >::iterator mapit;
...
public:
	...
	static int RemoteControl(REMOTE_CONTROL_PARAM* slpParam, char** lpRecvBuf, int BufSize);
